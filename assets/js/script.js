...
let jsonObject = window.json || {
    ...
    embed: {
        title: "Embed Title :wave:",
        description: "You can use [links](https://discord.com) And emoji :smile: 😎\n```or simple message!```",
        color: 0x41f097,
        ...
        fields: [
            {
                name: "Field 1, *Nyaa* **Naia**, ~~Yoto~~",
                value: "field value"
            },
            {
                name: "Field 2",
                value: "You can put custom emoji <:affection:1060511258400526346>",
                inline: false
            },
            {
                name: "Inline field",
                value: "Fields can be embedded.",
                inline: true
            },
            {
                name: "Inline field",
                value: "*Nya is the best.*",
                inline: true
            },
            {
                name: "Inline field",
            ...
            {
                name: "Other field",
                value: "> No, I didn't forget about it.",
                inline: false
            }
        ]
    }
